                    ...
                    <div class="xl:grid xl:grid-cols-2  flex flex-col-reverse"> 
                        <div className='DownloadOurApp-content xl:max-w-[685px] max-w-full lg:pt-20 pt-8 '> 
                            <div className='heading-box text-left mb-3.5'>
                                ...
                                <h2 className='xl:text-40 lg:text-[30px]  text-[25px]  font-bold'>Download Our App</h2>
                            </div>
                            <p className='text-lg xl:text-2xl font-bold text-[#753892]  mb-7'>Connect with compassionate experts dedicated to nurturing your growth and well-being.</p>
                            <p className='text-lg xl:text-2xl '>Experience personalized support on your spiritual journey through tailored meditation sessions and one-on-one consultations with skilled practitioners.</p>
