    ...
    <>
     <section className='SubscribeUs-wrap'> 
        <div class="SubscribeUs-card  shadow-shadow-color rounded-10 lg:py-9 lg:px-8 p-5">
            <h1 className='2xl:text-2xl text-xl font-bold text-center mb-6'> SubscribeUs</h1> 
            <form className='form-group mb-7'>
              <div className='icon-wrap relative'>
                 <input id="email" name="email" type="email" placeholder="Enter Email Address" class="pl-3 pr-9 border-[#CBCBCB] outline-0 lg:text-xl text-sm bg-transparent block w-full border-0 text-gray-900 border-b-2 py-3 placeholder:text-[#0F0202] focus:none  " />
                 <button type='submit' className=" absolute left-0 right-0 lg:top-3 top-5 ml-auto flex lg:w-[20px] w-[15px] "><Image src="/arrow.png" alt="logo white"  width={20} height={20}   /></button>
              </div> 
            </form>
