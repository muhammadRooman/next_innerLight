        ...
        <div className="2xl:container xl:container lg:container mx-auto px-5">
            <div className="inner-container relative">
                <div className="hero-banner-content max-w-[929px] mx-auto"> 
                    <h5 className="xl:text-40 lg:text-[30px] text-[22px] text-white font-bold text-center ">ابدأ رحلتك إلى</h5> 
                       {/* <div className='relative banner-img 2xl:min-h-[148px] sm:min-h-[120px] min-h-[60px] max-w-full'>
                        ...
                        <h1 class="wellness-text">WELLNESS</h1>
                    <p className="text-center text-white 2xl:text-2xl lg:text-xl  ">تحقيق الانسجام الداخلي من خلال اتباع نهج متوازن للعافية، ومزج الممارسات الجسدية والعقلية والروحية. عزز تقنيات التأمل والشفاء الخاصة بك بتوجيهات من الممارسين ذوي الخبرة.</p>
                </div>  
