                ...
                <div className="md:grid md:grid-cols-12 aboutUs  gap-6 "> 
                    <div  className="col-span-8">
                        <div className="heading-box text-left mb-5">
                            <h5 className="text-info-color 2xl:text-2xl font-black">{t("about_us")}</h5>
                            <h2 className="xl:text-40 lg:text-[30px] text-[24px]  font-bold">{t("transforming")}</h2>
                        </div>
                        ...
                        <h2 className="xl:text-40 lg:text-[30px] text-[25px] font-bold">{t("our_mission")}</h2>
                        <p className='text-lg font-normal mb-4 text-[#343434]'>{t("we_believe_that_true")}</p>
                        <p className='text-lg font-bold mb-4 text-[#343434]'>{t("through_our_teachings")}</p> 
