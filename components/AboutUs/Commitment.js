                    ...
                    <div className="lg:grid lg:grid-cols-12  gap-6"> 
                        ...
                        <div  className="col-span-5">
                            ...
                            <div className='btn-download flex'>
                                    <Link href="#" className="mr-3"><Image src="/AppStore.png" width={180} height={55} alt="AppStore"/></Link> 
                                    <Link href="#" className="rtl:mr-5 block"><Image src="/GooglePlay.png" width={180} height={55} alt="AppStore"/></Link> 
                            </div>
                        </div>
                    </div>
                </div>
