            ...
            <button
              ...
              className={
                !disabledPhoneOTP
                  ...
                  : "lg:text-lg block lg:w-[181px] w-full lg:order-none order-1 py-2.5 px-6 text-white rounded-3xl font-medium xl:text-xl text-sm bg-btn-gradient hover:bg-btn-gradient-hover  lg:text-lg block lg:w-[181px] w-full  "
              }
            >
              {t("sign_up")}
            </button>
