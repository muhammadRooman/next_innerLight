        ...
        <>
           <section className="site-banner benefits-banner relative bg-cover xl:min-h-[800px] min-h-[450px] flex items-center pb-10 lg:bg-center bg-center">
                ...
                <div className="site-banner-content max-w-[582px] ml-0 rtl:text-right"> 
                    <h1 className="xl:text-40 lg:text-[30px] text-[22px] text-info-color rtl:text-right font-bold text-left">{t("benefits")}</h1>
                    <p className="xl:text-50 lg:text-[40px] text-[30px] text-white rtl:text-right font-bold text-left xl:leading-[63px] lg:leading-[46px] mb-4">{t("unlock")}</p>
                    <p className="text-left text-white 2xl:text-2xl lg:text-xl rtl:text-right">{t("through_holistic")}</p>
