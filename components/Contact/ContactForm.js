            ...
            <section className="bg-[#F7F7F7] lg:p-24 md:p-12 p-6">
                <div className="2xl:container xl:container lg:container mx-auto flex justify-center">
                    ...
                    <div class="bg-white shadow-lg rounded-lg p-8 xl:w-1/2 lg:w-1/2 w-full">
                        <h2 class="xl:text-40 lg:text-[30px] text-[25px]  font-bold  text-[#0A448F] lg:text-left text-center">{t("contact_us")}</h2>
                        <p class="mb-6 text-[#000000] text text-[18px] font-normal lg:text-left text-center">{t("form")}</p>

                        <form>
                            <input type="text" placeholder={t("your_name")} class=" placeholder:text-[#11171F] w-full items-center rounded-[4px] bg-white  border-solid border-2 border-[#DEDEDE]   outline-1 -outline-offset-1 outline-[#DEDEDE] focus-within:outline-2 focus-within:-outline-offset-2 focus-within:outline-[#11171F] lg:min-h-[70px] min-h-[50px] block min-w-0 grow py-1.5 pr-5 pl-5 lg:text-lg  text-[#11171F]   focus:outline-none sm:text-sm/6 mb-5"/>
                            <input type="email" placeholder={t("email")} class=" placeholder:text-[#11171F] w-full items-center rounded-[4px] bg-white  border-solid border-2 border-[#DEDEDE]   outline-1 -outline-offset-1 outline-[#DEDEDE] focus-within:outline-2 focus-within:-outline-offset-2 focus-within:outline-[#11171F] lg:min-h-[70px] min-h-[50px] block min-w-0 grow py-1.5 pr-5 pl-5 lg:text-lg  text-[#11171F]   focus:outline-none sm:text-sm/6 mb-5" />
                            <input type="text" placeholder={t("contact_no")} class=" placeholder:text-[#11171F] w-full items-center rounded-[4px] bg-white  border-solid border-2 border-[#DEDEDE]   outline-1 -outline-offset-1 outline-[#DEDEDE] focus-within:outline-2 focus-within:-outline-offset-2 focus-within:outline-[#11171F] lg:min-h-[70px] min-h-[50px] block min-w-0 grow py-1.5 pr-5 pl-5 lg:text-lg  text-[#11171F]   focus:outline-none sm:text-sm/6 mb-5" />
                            <textarea placeholder={t("message")} class="placeholder:text-[#11171F] w-full p-4 border border-[#DEDEDE] focus:outline-none rounded-lg min-h-[180px] text-[18px] resize-none"></textarea>
                            <div className="btn-wrap text-right lg:mt-14 mt-10">
                                <Link href="#" className="py-2.5 px-11 text-white rounded-3xl font-medium xl:text-xl text-sm bg-btn-gradient hover:bg-btn-gradient-hover lg:text-lg">{t("submit")}</Link>
                            </div>
                        </form>
                    </div>
                </div>
