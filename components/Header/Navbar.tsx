      ...
      <div className="2xl:container xl:container lg:container mx-auto">
        <div className="header-inner flex justify-between items-center  xl:px-5 px-3 xl:py-2 lg:py-2">
          ...
          >
            ...
            <Link href="#" className="lg:text-black text-white py-1.5 lg:py-1 2xl:me-[88px] xl:me-[60px] lg:me-[40px] text-xl  xl:text-lg lg:text-[15px]  hover:text-[#1796D8] font-medium" onClick={() => setIsMenuOpen(false)}>{t("about")}</Link>
            <Link href="#" className="lg:text-black text-white py-1.5 lg:py-1 2xl:me-[88px] xl:me-[60px] lg:me-[40px] text-xl  xl:text-lg lg:text-[15px]  hover:text-[#1796D8] font-medium" onClick={() => setIsMenuOpen(false)}>{t("courses")} </Link>
            <Link href="#" className="lg:text-black text-white py-1.5 lg:py-1 2xl:me-[88px] xl:me-[60px] lg:me-[40px] text-xl  xl:text-lg lg:text-[15px]  hover:text-[#1796D8] font-medium" onClick={() => setIsMenuOpen(false)}>{t("benefits")}</Link>
            <Link href="#" className="lg:text-black text-white py-1.5 lg:py-1 2xl:me-[88px] xl:me-[60px] lg:me-[40px] text-xl  xl:text-lg lg:text-[15px]  hover:text-[#1796D8] font-medium" onClick={() => setIsMenuOpen(false)}>{t("subscription")}</Link>
            <Link href="#" className="lg:text-black text-white py-1.5 lg:py-1 2xl:me-[59px] xl:me-[40px] lg:me-[40px] text-xl  xl:text-lg lg:text-[15px] hover:text-[#1796D8] font-medium" onClick={() => setIsMenuOpen(false)}>{t("blog")} </Link>
