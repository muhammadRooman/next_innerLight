        ...
        <div class="SubscribeUs-card  shadow-shadow-color rounded-10 lg:py-9 lg:px-8 p-5">
            ...
            <form className='form-group mb-7'>
              <div className='icon-wrap relative'>
                 <input id="email" name="email" type="email" placeholder={t("enter_email_address")} class="pl-3 pr-9 border-[#CBCBCB] outline-0 lg:text-xl text-sm bg-transparent block w-full border-0 text-gray-900 border-b-2 py-3 placeholder:text-[#0F0202] focus:none rtl:pr-0 " />
